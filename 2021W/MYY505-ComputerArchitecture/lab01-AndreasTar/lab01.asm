...
prog:   # Words ending with ':' are **labels**
        ...
        # It's best not to write instructions in the same line as a label.

        lw         $s0, 0($a0)       # Get value from register $a0 which has the address of matric 
        		             # into register $s0.
                                     # THIS WILL BE MODIFIED TO LOAD FROM matric
                                     # This could probably also be done by loading straight from matric.
...
###############################################################################
        ...
        #  
matric: .word 4807    # This will be used by your submitted code
var1:   .word 1
